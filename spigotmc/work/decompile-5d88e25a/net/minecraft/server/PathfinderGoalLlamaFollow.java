...
public class PathfinderGoalLlamaFollow extends PathfinderGoal {
    ...
    public boolean a() {
        if (!this.a.isLeashed() && !this.a.dU()) {
            ...
            while (iterator.hasNext()) {
                ...
                if (entityllama1.dU() && !entityllama1.dT()) {
            ...
            if (entityllama == null) {
                ...
                while (iterator.hasNext()) {
                    entityllama1 = (EntityLlama) iterator.next();
                    if (entityllama1.isLeashed() && !entityllama1.dT()) {
                        d1 = this.a.h((Entity) entityllama1);
                        if (d1 <= d0) {
                            d0 = d1;
                            entityllama = entityllama1;
    ...
    public boolean b() {
        if (this.a.dU() && this.a.dV().isAlive() && this.a(this.a, 0)) {
            double d0 = this.a.h((Entity) this.a.dV());
    ...
    public void e() {
        if (this.a.dU()) {
            EntityLlama entityllama = this.a.dV();
    ...
    private boolean a(EntityLlama entityllama, int i) {
        if (i > 8) {
            return false;
        } else if (entityllama.dU()) {
            if (entityllama.dV().isLeashed()) {
                return true;
            } else {
                EntityLlama entityllama1 = entityllama.dV();
